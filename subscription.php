...
<body class="vertical-layout vertical-menu 2-columns fixed-navbar" data-open="click" data-menu="vertical-menu" data-color="bg-gradient-x-orange-yellow" data-col="2-columns" style="padding-top: 0px;">
    ...
    <center>
        ...
        <h1 class="text-uppercase mt-2">Choose your subscription</h1>
        <small><i>*Upon purchase, we provide a 7 - day free trial from the subscription plan you've choosen.</i></small>
    </center>
                                        <div class="form-group position-absolute position-top-0 position-right-0 mt-2">
                                            <a class="btn btn-warning btn-min-width mr-1 mb-1" href="home.php">Back to dashboard</a>
                                        </div>
